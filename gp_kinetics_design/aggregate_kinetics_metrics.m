...
%
% Loads saved results from kin_exp_01 through kin_exp_20 (regular 01-05,
...
%
% Prerequisite: Run kin_exp_01 through kin_exp_20 so .mat result files exist.
%
...
exp_files = {
    'results_kin_exp_01_regular_0noise.mat',  0,    true,  false;
    'results_kin_exp_02_regular_1noise.mat', 0.01, true,  false;
    'results_kin_exp_03_regular_5noise.mat', 0.05, true,  false;
    'results_kin_exp_04_regular_10noise.mat', 0.10, true,  false;
    'results_kin_exp_05_regular_20noise.mat', 0.20, true,  false;
    'results_kin_exp_06_irregular_0noise.mat',  0,    false, false;
    'results_kin_exp_07_irregular_1noise.mat', 0.01, false, false;
    'results_kin_exp_08_irregular_5noise.mat', 0.05, false, false;
    'results_kin_exp_09_irregular_10noise.mat', 0.10, false, false;
    'results_kin_exp_10_irregular_20noise.mat', 0.20, false, false;
    'results_kin_exp_11_regular_0noise_auto.mat',  0,    true,  true;
    'results_kin_exp_12_regular_1noise_auto.mat', 0.01, true,  true;
    'results_kin_exp_13_regular_5noise_auto.mat', 0.05, true,  true;
    'results_kin_exp_14_regular_10noise_auto.mat', 0.10, true,  true;
    'results_kin_exp_15_regular_20noise_auto.mat', 0.20, true,  true;
    'results_kin_exp_16_irregular_0noise_auto.mat',  0,    false, true;
    'results_kin_exp_17_irregular_1noise_auto.mat', 0.01, false, true;
    'results_kin_exp_18_irregular_5noise_auto.mat', 0.05, false, true;
    'results_kin_exp_19_irregular_10noise_auto.mat', 0.10, false, true;
    'results_kin_exp_20_irregular_20noise_auto.mat', 0.20, false, true
};
...
for ix = 1:size(exp_files, 1)
    ...
    t_max = 50;  % time span from ground_truth_kinetics [0, 50]
...
if isempty(T_all)
    error('No experiment files found. Run kin_exp_01 through kin_exp_20 so .mat files exist.');
end
