%% RUN_ALL_KINETICS_EXPERIMENTS  Run all GP kinetics experiments and aggregate metrics.
%
...
%   via run_kinetics_experiment, then aggregate_kinetics_metrics.
%
...
%     .do_aggregate - run aggregate_kinetics_metrics at end (default: true).
...
function run_all_kinetics_experiments(opts)
    ...
    %% Aggregate
    if do_aggregate
        fprintf('Running aggregate_kinetics_metrics.m\n');
        run(fullfile(script_dir, 'aggregate_kinetics_metrics.m'));
    end
    fprintf('Done.\n');
end
