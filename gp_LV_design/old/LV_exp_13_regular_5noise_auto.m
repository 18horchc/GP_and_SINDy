%% GP Lotka-Volterra Experiment 13: Regular sampling, 5% noise, Auto hyperparameter optimization
% Same as LV_exp_03 but with OptimizeHyperparameters = 'auto' for built-in kernels. Saves results_exp_13_regular_5noise_auto.mat.
clear; clc; close all;
...
xlabel('N'); ylabel('RMSE'); title('LV Exp 12: Prey — Regular, 5% noise, Auto');
...
xlabel('N'); ylabel('RMSE'); title('LV Exp 12: Predator — Regular, 5% noise, Auto');
legend('Location', 'best'); grid on; set(gca, 'XTick', N_list);
sgtitle('GP LV Exp 12: Regular sampling, 5% noise, Auto');
...
save(fullfile(script_dir, 'results_exp_12_regular_5noise_auto.mat'), 'T_point', 'T_prob', 'T_calib', 't_gt', 'prey_gt', 'pred_gt');
