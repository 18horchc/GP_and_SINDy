%% GP Lotka-Volterra Experiment 17: Irregular sampling, 1% noise, Auto hyperparameter optimization
% Same as LV_exp_07 but with OptimizeHyperparameters = 'auto' for built-in kernels. Saves results_exp_17_irregular_1noise_auto.mat.
clear; clc; close all;
...
xlabel('N'); ylabel('RMSE'); title('LV Exp 11: Prey — Irregular, 1% noise, Auto');
...
xlabel('N'); ylabel('RMSE'); title('LV Exp 11: Predator — Irregular, 1% noise, Auto');
legend('Location', 'best'); grid on; set(gca, 'XTick', N_list);
...
save(fullfile(script_dir, 'results_exp_17_irregular_1noise_auto.mat'), 'T_point', 'T_prob', 'T_calib', 't_gt', 'prey_gt', 'pred_gt');
