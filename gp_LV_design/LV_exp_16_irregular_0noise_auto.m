%% GP Lotka-Volterra Experiment 16: Irregular sampling, 0% noise, Auto hyperparameter optimization
% Same as LV_exp_06 but with OptimizeHyperparameters = 'auto' for built-in kernels. Saves results_exp_16_irregular_0noise_auto.mat.
clear; clc; close all;
...
xlabel('N'); ylabel('RMSE'); title('LV Exp 11: Prey — Irregular, 0% noise, Auto');
...
xlabel('N'); ylabel('RMSE'); title('LV Exp 11: Predator — Irregular, 0% noise, Auto');
legend('Location', 'best'); grid on; set(gca, 'XTick', N_list);
...
save(fullfile(script_dir, 'results_exp_16_regular_0noise_auto.mat'), 'T_point', 'T_prob', 'T_calib', 't_gt', 'prey_gt', 'pred_gt');
