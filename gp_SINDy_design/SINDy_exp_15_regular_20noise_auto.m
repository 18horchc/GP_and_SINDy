%% GP SINDy Experiment 15: Regular sampling, 20% noise, Auto hyperparameter optimization
% Same as SINDy_exp_05 but with OptimizeHyperparameters = 'auto'. Saves results_SINDy_exp_15_regular_220noise_auto.mat.
clear; clc; close all;
...
xlabel('N'); ylabel('RMSE'); title('SINDy Exp 11: M1 — Regular, 20% noise, Auto');
...
xlabel('N'); ylabel('RMSE'); title('SINDy Exp 11: M2 — Regular, 20% noise, Auto');
legend('Location', 'best'); grid on; set(gca, 'XTick', N_list);
...
save(fullfile(script_dir, 'results_SINDy_exp_15_regular_20noise_auto.mat'), 'T_point', 'T_prob', 'T_calib', 't_gt', 'M1_gt', 'M2_gt');
