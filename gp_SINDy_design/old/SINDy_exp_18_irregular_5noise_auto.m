%% GP SINDy Experiment 18: Irregular sampling, 5% noise, Auto hyperparameter optimization
% Same as SINDy_exp_08 but with OptimizeHyperparameters = 'auto'. Saves results_SINDy_exp_18_irregular_5noise_auto.mat.
clear; clc; close all;
...
xlabel('N'); ylabel('RMSE'); title('SINDy Exp 11: M1 — Irregular, 5% noise, Auto');
...
xlabel('N'); ylabel('RMSE'); title('SINDy Exp 11: M2 — Irregular, 5% noise, Auto');
legend('Location', 'best'); grid on; set(gca, 'XTick', N_list);
...
save(fullfile(script_dir, 'results_SINDy_exp_18_irregular_5noise_auto.mat'), 'T_point', 'T_prob', 'T_calib', 't_gt', 'M1_gt', 'M2_gt');
writetable(T_point, fullfile(script_dir, 'results_SINDy_exp_16_point_metrics.csv'));
writetable(T_prob, fullfile(script_dir, 'results_SINDy_exp_16_prob_metrics.csv'));
writetable(T_calib, fullfile(script_dir, 'results_SINDy_exp_16_calib_metrics.csv'));
