%% GP SINDy Experiment 17: Irregular sampling, 1% noise, Auto hyperparameter optimization
% Same as SINDy_exp_07 but with OptimizeHyperparameters = 'auto'. Saves results_SINDy_exp_17_irregular_1noise_auto.mat.
clear; clc; close all;
...
xlabel('N'); ylabel('RMSE'); title('SINDy Exp 11: M1 — Irregular, 1% noise, Auto');
...
xlabel('N'); ylabel('RMSE'); title('SINDy Exp 11: M2 — Irregular, 1% noise, Auto');
legend('Location', 'best'); grid on; set(gca, 'XTick', N_list);
...
save(fullfile(script_dir, 'results_SINDy_exp_17_irregular_1noise_auto.mat'), 'T_point', 'T_prob', 'T_calib', 't_gt', 'M1_gt', 'M2_gt');
