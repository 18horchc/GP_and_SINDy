%% GP SINDy Experiment 20: Irregular sampling, 20% noise, Auto hyperparameter optimization
% Same as SINDy_exp_10 but with OptimizeHyperparameters = 'auto'. Saves results_SINDy_exp_20_irregular_220noise_auto.mat.
clear; clc; close all;
...
xlabel('N'); ylabel('RMSE'); title('SINDy Exp 11: M1 — Irregular, 20% noise, Auto');
...
xlabel('N'); ylabel('RMSE'); title('SINDy Exp 11: M2 — Irregular, 20% noise, Auto');
legend('Location', 'best'); grid on; set(gca, 'XTick', N_list);
...
save(fullfile(script_dir, 'results_SINDy_exp_20_irregular_20noise_auto.mat'), 'T_point', 'T_prob', 'T_calib', 't_gt', 'M1_gt', 'M2_gt');
